...
from routers.movie_direction import moviedirection_router
from routers.movie_genres import moviegenres_router
...
app.include_router(moviedirection_router)
app.include_router(moviegenres_router)
